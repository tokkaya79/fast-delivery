                ...
                <div className="footer__date">
                    ...
                    <ul className="footer__list">
                        ...
                        <li className="footer__item">
                         ...
                         <li className="footer__item">
                            <a href="/" className="footer__link">Report</a>
                        </li> 
                    </ul>
                    <ul className="footer__list">
                    ...
                    <ul className="footer__social">
                        <li className="footer__item-title--social">Social</li>
                        <li className="footer__item">
                         ...
                         <li className="footer__item--point">
                            <a href="/" className="footer__link--point"><img src={point} alt="point" /></a>
                            <a href="/" className="footer__link"><img src={phone} alt="phone" /></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div className='footer__bottom'>
                <p className='footer__copyright-text'>© Copyright 2020, All rights reserved</p>
                <div className="footer__paymant">
                    <a className='footer__link--help' href="/"> <span>?</span><p>Help Center</p></a>
                    <a className='footer__link--payment' href="/"><img src={payment} alt="payment-icons" /></a>
                </div>
            </div>
        </section>
    );
